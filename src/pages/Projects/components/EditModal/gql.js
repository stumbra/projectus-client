...
export const UPDATE_PROJECT_SPECS_MUTATION = gql`
  mutation updateProjectSpecs($project: ID!, $title: String, $description: String) {
    updateProjectSpecs(project: $project, title: $title, description: $description) {
      title
      description
    }
  }
...
export const ADD_PERSON_TO_PROJECT_MUTATION = gql`
  mutation sendInviteToProject($project: ID!, $email: String!, $perk: PerkType!) {
